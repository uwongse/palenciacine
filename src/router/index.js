  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {path: 'proximamenteortega/:id/:names', name: 'proximamenteortega', component: AppModal}
      ]
    },
    {
      path: '/obrasavenida',
      ...
      children: [
        ...
        {path: 'proximamenteavenida/:id/:names', name: 'proximamenteavenida', component: AppModal}
      ]
    },
    {
      path: '*', redirect: '/'
