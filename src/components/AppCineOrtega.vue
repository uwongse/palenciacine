                    ...
                    <section class="abajo">
                        <section id="izq">
                            <section id="direccion"><img id="logoimg" src="../assets/ubicacion.png" alt="">
                                <p>C. Colón, 2, BAJO, 34002 Palencia</p>
                            </section>
                            <section id="telefono"><img id="logoimg" src="../assets/movil.png" alt="">
                                <p>979 70 70 88</p>
                            </section>
                        ...
                        <section id="der" class="z-depth-1-half map-container">
                            <p> Construido en el año 1937 por el arquitecto Luis Cazcón y reformado posteriormente en 1997 por los arquitectos Luis Gutiérrez y Juan Luis Gutiérrez.
