                        ...
                        <article id="der">
                            <article id="horarios" v-if="dato.projections">
                                <article id="cineortega">
                                    ...
                                    <article class="hour"><span id="yellow" v-for="dat in dato.projections" :key="dat.id">{{ dat.hour}} </span></article><a id="boton" type="button" class="btn-sm" :href="`${dato.buy}`"><b>Comprar entradas</b></a>
                                </article>
                            </article>
                            ...
                            <article id="actores" v-if="dato.actors[0]">
                                <article id="actor">
                                    ...
                                    <p id="gray" class="espacio" v-for="dat in dato.actors" :key="dat.id">{{dat.actor}},&nbsp;</p>
                                </article>
                            </article>
