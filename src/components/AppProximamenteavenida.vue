                ...
                <section class="movies-list">
                    <section class="movie" v-for="movie in films" :key="movie.id">
                        ...
                        <section class="details">
                            <router-link class="item" :to="{path:`obrasavenida/proximamenteavenida/${movie.id}/${sanitizeTitle(movie.title)}`}" >
                            ...
                            <section class="detalles">
                                ...
                                <button>
                                    ...
                                    <router-link class="item" :to="{path:`obrasavenida/proximamenteavenida/${movie.id}/${sanitizeTitle(movie.title)}`}"><i>Más Información</i></router-link >
                                </button>
